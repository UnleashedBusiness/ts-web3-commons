import {
  ...
  polygon, polygonAmoy,
  polygonMumbai, polygonZkEvm, polygonZkEvmTestnet, sepolia,
} from 'viem/chains';
import { DefaultEVMNativeTokenDecimalSize } from '../utils/chains.js';
import { blockchainIndex } from '../utils/chains.extensions.js';
